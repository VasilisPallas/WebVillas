<form id="villaform" name="villaform"  enctype="multipart/form-data" action="uploadvillahandler.php" method="POST">
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td><input style="width: 215px; height: 17px; " class="inputs" type="text" id="villaname" name="villaname" size="50" maxlength="50"></td>
        </tr>
        ...
        <tr>
            ...
            <td><input style="width: 215px; height: 17px; " class="inputs" type="text" id="address" name="address" size="50" maxlength="50"> <input style="width: 30px; height: 17px;" class="inputs" type="text" id="addressno" name="addressno" size="3" maxlength="3"></td>
        </tr>

        <tr>
            <td class="right" style = "padding: 0 0 25px 95px; font-size: 1.2em;">* Τ.Κ</td>
            <td><input class="inputs" style="width: 80px; height: 17px;  " type="text" id="postalcode" name="postalcode" size="10" maxlength="10"></td>
        </tr>
        ...
        <tr>
            <td></td>
            <td><a href="maps.php" target="_blank" class="whitebutton" style="margin-bottom: 20px;" >Πρόσθεσε στον χάρτη</a><input  name="coords" id="coords" type="text"></td>
        </tr>
        <tr>
            <td></td>
